...
- Test files organized by feature (01-authentication, 02-todo-crud, etc.)
...
- `USER_GUIDE.md` provides comprehensive documentation of all features
...
- **Documentation**: `USER_GUIDE.md` (comprehensive feature guide)
